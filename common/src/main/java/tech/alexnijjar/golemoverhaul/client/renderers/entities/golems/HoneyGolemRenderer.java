...
public class HoneyGolemRenderer extends BaseGolemRenderer<HoneyGolem> {
    ...
    public static final ResourceLocation FULL_TEXTURE_1 = new ResourceLocation(GolemOverhaul.MOD_ID, "textures/entity/honey/honey_golem_full_1.png");
    public static final ResourceLocation FULL_TEXTURE_2 = new ResourceLocation(GolemOverhaul.MOD_ID, "textures/entity/honey/honey_golem_full_2.png");
    public static final ResourceLocation FULL_TEXTURE_3 = new ResourceLocation(GolemOverhaul.MOD_ID, "textures/entity/honey/honey_golem_full_3.png");
    ...
    public ResourceLocation getTextureLocation(HoneyGolem golem) {
        if (!golem.isFullOfHoney()) return super.getTextureLocation(golem);
