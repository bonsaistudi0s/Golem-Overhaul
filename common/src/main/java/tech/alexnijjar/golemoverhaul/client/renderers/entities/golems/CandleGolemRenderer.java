...
public class CandleGolemRenderer extends BaseGolemRenderer<CandleGolem> {
    ...
    public static final ResourceLocation GLOW_1 = new ResourceLocation(GolemOverhaul.MOD_ID, "textures/entity/candle/candle_golem_1_glow.png");
    public static final ResourceLocation GLOW_2 = new ResourceLocation(GolemOverhaul.MOD_ID, "textures/entity/candle/candle_golem_2_glow.png");

    public static final ResourceLocation MODEL_1 = new ResourceLocation(GolemOverhaul.MOD_ID, "geo/entity/candle/candle_golem_1.geo.json");
    public static final ResourceLocation MODEL_2 = new ResourceLocation(GolemOverhaul.MOD_ID, "geo/entity/candle/candle_golem_2.geo.json");
    public static final ResourceLocation MODEL_3 = new ResourceLocation(GolemOverhaul.MOD_ID, "geo/entity/candle/candle_golem_3.geo.json");
        ...
        addRenderLayer(new AutoGlowingGeoLayer<>(this) {
            ...
            protected RenderType getRenderType(CandleGolem golem) {
                return switch (golem.getCrackiness()) {
                    ...
                    case HIGH -> super.getRenderType(golem);
                };
            }
