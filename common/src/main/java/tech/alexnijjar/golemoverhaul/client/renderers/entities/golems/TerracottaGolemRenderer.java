...
public class TerracottaGolemRenderer extends BaseGolemRenderer<TerracottaGolem> {
    ...
    public static final ResourceLocation MODEL = GolemOverhaul.asResource("geo/entity/terracotta/terracotta_golem.geo.json");
    public static final ResourceLocation CACTUS_MODEL = GolemOverhaul.asResource("geo/entity/terracotta/cactus_terracotta_golem.geo.json");
    public static final ResourceLocation DEAD_BUSH_MODEL = GolemOverhaul.asResource("geo/entity/terracotta/dead_bush_terracotta_golem.geo.json");
