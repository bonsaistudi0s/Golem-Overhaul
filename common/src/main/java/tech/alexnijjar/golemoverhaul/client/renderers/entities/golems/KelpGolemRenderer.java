...
public class KelpGolemRenderer extends BaseGolemRenderer<KelpGolem> {
    ...
    public static final ResourceLocation GLOW = new ResourceLocation(GolemOverhaul.MOD_ID, "textures/entity/kelp/kelp_golem_glow.png");
    ...
    public KelpGolemRenderer(EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new AutoGlowingGeoLayer<>(this) {
            @Override
            protected RenderType getRenderType(KelpGolem golem) {
