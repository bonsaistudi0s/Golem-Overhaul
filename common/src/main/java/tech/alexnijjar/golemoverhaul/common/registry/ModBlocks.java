...
public class ModBlocks {
    ...
    public static final RegistryEntry<Block> CLAY_GOLEM_STATUE = BLOCKS.register("clay_golem_statue", () -> new ClayGolemStatueBlock(Block.Properties.copy(Blocks.CLAY).noOcclusion().randomTicks()));
}
