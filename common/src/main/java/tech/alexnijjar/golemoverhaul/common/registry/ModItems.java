...
public class ModItems {
    ...
    public static final RegistryEntry<CreativeModeTab> TAB = TABS.register("main", () -> new ResourcefulCreativeModeTab(new ResourceLocation(GolemOverhaul.MOD_ID, "main"))
        .setItemIcon(() -> ModItems.NETHERITE_GOLEM_SPAWN_EGG.get())
        .addRegistry(ITEMS)
        .build());

    public static final RegistryEntry<Item> BARREL_GOLEM_SPAWN_EGG = SPAWN_EGGS.register("barrel_golem_spawn_egg", createSpawnEggItem(ModEntityTypes.BARREL_GOLEM, 0xb47f44, 0x603c2d, new Item.Properties()));
    ...
    public static final RegistryEntry<Item> HAY_GOLEM_SPAWN_EGG = SPAWN_EGGS.register("hay_golem_spawn_egg", createSpawnEggItem(ModEntityTypes.HAY_GOLEM, 0xcd8d37, 0xd9c373, new Item.Properties()));
    ...
    public static final RegistryEntry<Item> KELP_GOLEM_SPAWN_EGG = SPAWN_EGGS.register("kelp_golem_spawn_egg", createSpawnEggItem(ModEntityTypes.KELP_GOLEM, 0x56d0b6, 0x548324, new Item.Properties()));
