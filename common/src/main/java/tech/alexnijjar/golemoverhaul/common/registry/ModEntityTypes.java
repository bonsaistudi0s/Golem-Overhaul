...
public class ModEntityTypes {
    ...
    public static final RegistryEntry<EntityType<CandleFlameProjectile>> CANDLE_FLAME = PROJECTILES.register("candle_flame", () ->
        createEntityBuilder((EntityType.EntityFactory<CandleFlameProjectile>) CandleFlameProjectile::new, MobCategory.MISC)
            .sized(0.25F, 0.25F)
    ...
    public static final RegistryEntry<EntityType<HoneyBlobProjectile>> HONEY_BLOB = PROJECTILES.register("honey_blob", () ->
        createEntityBuilder((EntityType.EntityFactory<HoneyBlobProjectile>) HoneyBlobProjectile::new, MobCategory.MISC)
            .sized(0.25F, 0.25F)
            .clientTrackingRange(4)
            .updateInterval(10)
            .build("honey_blob"));
    ...
    private static void registerSpawnPlacements() {
        SpawnPlacementsRegistry.register(ModEntityTypes.BARREL_GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, BarrelGolem::checkMobSpawnRules);
        SpawnPlacementsRegistry.register(ModEntityTypes.CANDLE_GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, CandleGolem::checkMobSpawnRules);
        SpawnPlacementsRegistry.register(ModEntityTypes.COAL_GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, CoalGolem::checkMobSpawnRules);
        SpawnPlacementsRegistry.register(ModEntityTypes.HAY_GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, HayGolem::checkMobSpawnRules);
        SpawnPlacementsRegistry.register(ModEntityTypes.HONEY_GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, HoneyGolem::checkMobSpawnRules);
        SpawnPlacementsRegistry.register(ModEntityTypes.KELP_GOLEM, SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, KelpGolem::checkMobSpawnRules);
        SpawnPlacementsRegistry.register(ModEntityTypes.NETHERITE_GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, NetheriteGolem::checkMobSpawnRules);
        SpawnPlacementsRegistry.register(ModEntityTypes.SLIME_GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SlimeGolem::checkSlimeSpawnRules);
        SpawnPlacementsRegistry.register(ModEntityTypes.TERRACOTTA_GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, TerracottaGolem::checkMobSpawnRules);
    }
