...
public class TerracottaGolem extends BaseGolem implements IShearable, RangedAttackMob {
    ...
    public TerracottaGolem(EntityType<? extends AbstractGolem> type, Level level) {
        super(type, level, true, GolemOverhaulConfig.allowSpawning && GolemOverhaulConfig.spawnTerracottaGolems);
        this.xpReward = 6;
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(ID_TYPE, (byte) 0);
    }
    ...
    public void addAdditionalSaveData(CompoundTag compound) {
        ...
        if (!this.equippedStack.isEmpty()) {
            compound.put("item", this.equippedStack.save(new CompoundTag()));
        }
    }
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        if (compound.contains("item", CompoundTag.TAG_COMPOUND)) {
            this.equippedStack = ItemStack.of(compound.getCompound("item"));
        }
    }
