...
public class BarrelGolem extends BaseGolem {
    ...
    public static final ResourceLocation BARTERING_LOOT = new ResourceLocation(GolemOverhaul.MOD_ID,
            "gameplay/barrel_golem_bartering");
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(ID_OPEN, true);
        this.entityData.define(ID_DAY_START_TICKS, WAKE_UP_TICKS);
    }
    ...
    private List<ItemStack> getBarterResponseItems() {
        if (level() instanceof ServerLevel level) {
            LootTable lootTable = level.getServer().getLootData().getLootTable(BARTERING_LOOT);
