...
public class GolemOverhaulConfigLinks {

    public static final ResourcefulConfigLink GITHUB = create(Type.GITHUB, "https://github.com/bonsaistudi0s/golem-overhaul");
    public static final ResourcefulConfigLink DISCORD = create(Type.DISCORD, "https://discord.gg/sGwxnFV");
    public static final ResourcefulConfigLink MODRINTH = create(Type.MODRINTH, "https://modrinth.com/mod/golem-overhaul");
    public static final ResourcefulConfigLink CURSEFORGE = create(Type.CURSEFORGE, "https://www.curseforge.com/minecraft/mc-mods/golem-overhaul");
